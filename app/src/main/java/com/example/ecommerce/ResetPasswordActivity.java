        ...
        if (question1.equals("") && question2.equals(""))
        {
            ...
            ref.child("Security Question").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this,"you have answer security question successfully",Toast.LENGTH_SHORT).show();
...
if(!phone.equals("")  && !answer1.equals("")  && !answer2.equals(""))
{
    ...
    ref.addValueEventListener(new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            {
                Toast.makeText(ResetPasswordActivity.this,"This phone number is not exits ",Toast.LENGTH_SHORT).show();
    ...
    Toast.makeText(ResetPasswordActivity.this,"please complete the from ",Toast.LENGTH_SHORT).show();
}
